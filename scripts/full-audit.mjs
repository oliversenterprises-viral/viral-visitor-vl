...
// 4. Reddit Ads pixel (PageVisit) on public homepage
report.checks.redditAds = {
  pixelScript: html.includes('redditstatic.com/ads/pixel.js'),
  officialPixelId: html.includes('a2_ir6sjdbsj2n4'),
  noStalePixelId: !html.includes('a2_jr6jdbg2r4'),
  rdtInit: html.includes("rdt('init','a2_ir6sjdbsj2n4')") || html.includes('rdt("init","a2_ir6sjdbsj2n4")'),
  pageVisit: html.includes("rdt('track','PageVisit')") || html.includes('rdt("track","PageVisit")'),
};
