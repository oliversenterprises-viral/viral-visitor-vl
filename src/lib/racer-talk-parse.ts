 ...
 * Same CMS keys as Website content (owner_broadcast_*). Missing keys = no panel.
 * Deno-safe — re-exported by supabase/functions/_shared/racer-talk.ts.
 */
...
export function messageFromTalkContent(
  ...
  return parseRacerTalkMessage(content);
}
