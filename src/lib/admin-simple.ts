/**
 * First screen is the five-number desk. Prize and Website stay behind a visible More.
...
/** Website (2) and Prize (3) — the only extra screens. */
export const ADMIN_EXTRA_TABS = [2, 3] as const;
