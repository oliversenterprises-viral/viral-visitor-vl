...
const LOCKED_UTM_HERO: HeroCtaCopy = {
  ...
  trustLine: "This week's #1 (not the owner) with 3 friends gets the 7-day banner.",
  buttonLabel: 'Get my referral link',
};

const UTM_HERO_COPY: Record<UtmHeroSegment, HeroCtaCopy> = {
  traffic_exchange: { ...LOCKED_UTM_HERO },
  linkedin: { ...LOCKED_UTM_HERO },
  reddit: { ...LOCKED_UTM_HERO },
  paid: { ...LOCKED_UTM_HERO },
  telegram: { ...LOCKED_UTM_HERO },
  social: { ...LOCKED_UTM_HERO },
};
